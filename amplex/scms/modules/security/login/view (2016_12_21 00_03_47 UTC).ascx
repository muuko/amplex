<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="view.ascx.cs" Inherits="scms.modules.security.login.view" %>
...
<asp:PlaceHolder ID="placeHolderLoggedIn" runat="server">
	<strong>Currently Logged In User:</strong> <asp:Literal ID="literalUser" runat="server"></asp:Literal>
	<p><asp:Button ID="btnLogOutx" runat="server" OnClick="btnLogOut_Clicked" Text="Logout"></asp:Button></p>
</asp:PlaceHolder>
				...
				<asp:View ID="viewLogin" runat="server">
						<asp:Panel ID="panelLogin" runat="server" DefaultButton="btnLogin">
								<table class="login-table">
										<tr>
												<td valign="top" class="login-label"><strong>User Name:</strong></td>
												<td valign="top" class="login-value">
										...
										<tr>
												<td valign="top" class="login-label"><strong>Password:</strong></td>
												<td valign="top" class="login-value">
