...
use amplex
declare @count int
exec scms_form_submissions_get @formid = 1, @pageSize = 0, @pageNumber = 0, @orderby = 'name', @ascending = 0, @dateFrom = '7-23-2010', @dateTo = '7-25-2010', @count = @count out
select @count '@count'
select * from scms_form_submission
*/