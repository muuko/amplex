if exists ( select [id] from sysobjects where xtype='p' and [name] = 'cat_part_search2' )
	drop procedure cat_part_search2
go

create procedure cat_part_search2
(
...
begin
	...
	begin
		...
		order by cat_part.sage_description1
	end
...
/*
declare @count int
exec cat_part_search2
	@searchText = 'oak,rose',
	@searchInDescription1 = 1,
	@searchInDescription2 = 1,
	@searchInDescription3 = 0,
	@searchInLongDescription = 0,
	@powerSearch  = 1,
	@orderBy = 'description1', --'description2', -- common, botanical, description
	@pageSize = 50,
	@pageNumber = null,
	@count = @count out
select '@count', @count
